    ...
    return (
        <section className="about padding">
            ...
            <div className="image-content">
                <img src="https://www.zillowstatic.com/s3/web-platform/sub-apps/hops-homepage/hops-homepage.prod.master.6997174.763f0471/web/0b326d5cfd5d9622edb6b1e7c5b6f8d2.webp" alt="" />
            </div>
        </section>
    )
}
